...
def _translate_lines_with_vocab(lines: list, all_words: list,
    ...
    prompt = (
        ...
        "   - แชท (bubble ซ้าย/ขวา) → ระบุผู้พูดทุกบรรทัด\n"
        "     วิธีระบุ: bubble ฝั่งซ้าย = A, bubble ฝั่งขวา = B "
        "ถ้ามีชื่อปรากฏในภาพให้ใช้ชื่อนั้นแทน A หรือ B\n"
        "   - บทสนทนาในหนังสือ (ชื่อ: ข้อความ) → ใช้ชื่อจากภาพ "
        "ถ้าไม่มีชื่อดูว่าข้อความอยู่ฝั่งไหนแล้วใช้ A B C\n"
