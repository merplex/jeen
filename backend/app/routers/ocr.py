...
def _translate_lines_with_vocab(lines: list, all_words: list,
    ...
    prompt = (
        ...
        "     วิธีระบุผู้พูด: ดูว่า avatar หรือชื่อที่ปรากฏข้างบรรทัดนั้นเหมือนกับบรรทัดไหนบ้าง "
        "คนเดียวกัน (avatar/ชื่อเหมือนกัน) ต้องได้ตัวอักษรเดิมเสมอ "
        "ถ้ามี 2 คน → A: B:, ถ้ามี 3 คน → A: B: C: "
        "ใช้ชื่อจากภาพถ้าเห็นชัด ถ้าไม่เห็นใช้ A B C\n"
