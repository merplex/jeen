...
def _translate_lines_with_vocab(lines: list, all_words: list,
    ...
    prompt = (
        ...
        "   - แชท (bubble ซ้าย/ขวา หรือ avatar/ชื่อข้างข้อความ) หรือบทสนทนาในหนังสือ → ระบุผู้พูดทุกบรรทัด\n"
        "     วิธีระบุผู้พูด:\n"
        "     (1) ถ้ามีชื่อข้อความ → ใช้ชื่อนั้น\n"
        "     (2) ถ้ามีแค่ avatar รูปภาพ → เปรียบเทียบ รูปร่าง สี ลักษณะของ avatar แต่ละอัน "
        "avatar ที่หน้าตาเหมือนกัน = คนเดียวกัน ให้ตัวอักษรเดิม "
        "avatar ที่หน้าตาต่างกัน = คนละคน ให้ตัวอักษรต่างกัน\n"
        "     ถ้ามี 2 คน → A: B:, ถ้ามี 3 คน → A: B: C:\n"
