...
def _ocr_structured(image_bytes: bytes, mime_type: str) -> dict:
    ...
    prompt = (
        ...
        "4. การหา align: ให้ดูที่ avatar/รูปโปรไฟล์ขนาดเล็กที่อยู่ระดับบนเดียวกับ bubble นั้น\n"
        "   - avatar อยู่ฝั่งขวาของ bubble → align = right\n"
        "   - avatar อยู่ฝั่งซ้ายของ bubble → align = left\n"
        "   - ถ้าไม่มี avatar ให้ดูว่า bubble ชิดขอบไหนมากกว่า\n"
        "   - bubble ยาวเกือบเต็มจอ: ดู avatar ก่อนเสมอ อย่าดูแค่ความยาว bubble\n"
        "5. ถ้าไม่มีอะไรเลยในรูป ตอบ: {\"lines\":[]}"
    )
