          ...
          <div className="space-y-3">
            ...
            <div className={`bg-white rounded-2xl p-4 shadow-sm border-2 ${tier === 'learner' ? 'border-blue-200 opacity-60' : 'border-blue-100'}`}>
              <div className="flex items-center justify-between mb-3">
                ...
                >
                  {purchasing ? <span className="w-4 h-4 rounded-full animate-spin align-middle" style={{background:'conic-gradient(#fff 0deg 90deg,transparent 90deg 180deg,#fff 180deg 270deg,transparent 270deg 360deg)',display:'inline-block',verticalAlign:'middle'}} /> : tier === 'learner' ? 'ใช้งานอยู่' : tier === 'superuser' ? 'Downgrade' : 'สมัคร'}
                </button>
              </div>
            ...
            <div className={`bg-white rounded-2xl p-4 shadow-sm border-2 ${tier === 'superuser' ? 'border-yellow-300 opacity-60' : 'border-yellow-200'}`}>
              <div className="flex items-center justify-between mb-3">
                ...
                >
                  {purchasing ? <span className="w-4 h-4 rounded-full animate-spin align-middle" style={{background:'conic-gradient(#fff 0deg 90deg,transparent 90deg 180deg,#fff 180deg 270deg,transparent 270deg 360deg)',display:'inline-block',verticalAlign:'middle'}} /> : tier === 'superuser' ? 'ใช้งานอยู่' : 'สมัคร'}
                </button>
              </div>
              <div className="space-y-1.5 text-sm text-gray-600">
                {tier === 'learner' ? (
